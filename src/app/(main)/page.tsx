    ...
    <>
      ...
      <section className="relative h-[60vh] w-full">
        ...
        <div className="container relative z-10 flex h-full flex-col items-start justify-center text-white">
          <h1 className="text-4xl font-extrabold md:text-6xl">Elevate Your Lifestyle</h1>
          <p className="mt-4 max-w-lg text-lg">Discover curated collections and exclusive deals.</p>
                ...
                <Card className="overflow-hidden transition-all hover:shadow-xl">
                  <CardHeader className="p-0">
                    <Image
                      ...
                      data-ai-hint={PlaceHolderImages.find(img => img.imageUrl === category.imageURL)?.imageHint || 'category image'}
                    />
                  </CardHeader>
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            ...
            <div className="text-center">
              ...
              <p className="mt-2 text-muted-foreground">Your payments are processed securely with our partners.</p>
            </div>
            <div className="text-center">
              <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-primary/10 text-primary">
              ...
              <p className="mt-2 text-muted-foreground">Enjoy access to exclusive deals and discounts.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-muted py-12 md:py-20">
        <div className="container text-center">
          ...
          <p className="mt-2 text-muted-foreground">Sign up to get the latest on sales, new releases and more.</p>
